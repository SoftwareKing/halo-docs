package org.xujin.docs.detector;
...
public interface Detector {
	 ...
	 */
	Collection<Resource> detect(Filter... filters) throws IOException;
	 ...
	 *             when I/O error occur
	 */
	Collection<Resource> detect(Collection<Filter> filters) throws IOException;
	 ...
	 *             when I/O error occur
	 */
	Collection<Resource> detect(FilterChain chain) throws IOException;
